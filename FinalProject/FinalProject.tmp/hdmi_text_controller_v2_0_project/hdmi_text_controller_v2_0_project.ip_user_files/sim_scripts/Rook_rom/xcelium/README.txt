...
#
# Generated by export_simulation on Mon Apr 28 23:40:20 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './Rook_rom.sh' script.

./Rook_rom.sh -reset_run
...
./Rook_rom.sh -noclean_files

For more information on the script, please type './Rook_rom.sh -help'.
