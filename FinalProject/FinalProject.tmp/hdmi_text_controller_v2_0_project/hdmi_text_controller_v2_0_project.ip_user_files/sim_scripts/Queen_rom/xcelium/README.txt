...
#
# Generated by export_simulation on Mon Apr 28 23:36:12 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './Queen_rom.sh' script.

./Queen_rom.sh -reset_run
...
./Queen_rom.sh -noclean_files

For more information on the script, please type './Queen_rom.sh -help'.
