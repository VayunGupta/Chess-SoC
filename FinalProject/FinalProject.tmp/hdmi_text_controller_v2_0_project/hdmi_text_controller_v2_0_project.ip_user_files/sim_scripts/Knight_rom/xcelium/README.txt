...
#
# Generated by export_simulation on Mon Apr 28 23:34:32 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './Knight_rom.sh' script.

./Knight_rom.sh -reset_run
...
./Knight_rom.sh -noclean_files

For more information on the script, please type './Knight_rom.sh -help'.
