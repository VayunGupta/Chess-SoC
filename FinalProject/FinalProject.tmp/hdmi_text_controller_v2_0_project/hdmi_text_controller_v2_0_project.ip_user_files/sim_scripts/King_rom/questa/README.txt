...
#
# Generated by export_simulation on Mon Apr 28 23:33:46 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './King_rom.sh' script.

./King_rom.sh -reset_run
...
./King_rom.sh -noclean_files

For more information on the script, please type './King_rom.sh -help'.
