...
#
# Generated by export_simulation on Tue Apr 29 20:03:01 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './chessBoard_rom.sh' script.

./chessBoard_rom.sh -reset_run
...
./chessBoard_rom.sh -noclean_files

For more information on the script, please type './chessBoard_rom.sh -help'.
