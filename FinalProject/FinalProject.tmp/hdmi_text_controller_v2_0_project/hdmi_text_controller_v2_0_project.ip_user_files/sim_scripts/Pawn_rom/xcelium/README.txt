...
#
# Generated by export_simulation on Mon Apr 28 23:35:17 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './Pawn_rom.sh' script.

./Pawn_rom.sh -reset_run
...
./Pawn_rom.sh -noclean_files

For more information on the script, please type './Pawn_rom.sh -help'.
