...
HD_PWD='c:/users/versa/ece385/finalproject/finalproject.tmp/hdmi_text_controller_v2_0_project/hdmi_text_controller_v2_0_project.runs/Queen_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Queen_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Queen_rom.tcl
