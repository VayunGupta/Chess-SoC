...
HD_PWD='c:/users/versa/ece385/finalproject/finalproject.tmp/hdmi_text_controller_v2_0_project/hdmi_text_controller_v2_0_project.runs/Knight_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Knight_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Knight_rom.tcl
