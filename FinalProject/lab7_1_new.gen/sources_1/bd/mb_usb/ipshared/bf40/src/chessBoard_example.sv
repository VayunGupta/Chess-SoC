...
logic [3:0] pal_r, pal_g, pal_b, pawn_r, pawn_g, pawn_b, knight_r, knight_g, knight_b, bishop_r, bishop_g, bishop_b, rook_r, rook_g, rook_b, queen_r, queen_g, queen_b, king_r, king_g, king_b, out_r, out_g, out_b;
logic [5:0] px, py;
logic [11:0] spr_addr;
...
logic [3:0] sq_data; // contains the encoding 
always_comb begin
   sq_data = chesscodes[rank * 32 + file *4 +:4];
end

//Piece 3-bit encoding
always_comb begin
    case (sq_data[2:0])
